...
import eu.branislavpalacka.library.DB.repository.StatusOfBooksRepository;
import eu.branislavpalacka.library.DB.services.api.StatusOfBookService;
import eu.branislavpalacka.library.DB.services.api.request.UpdateStatusOfBooksRequest;
